...
<body >
    <div>
        ...
        <div id="order_section">
            <div id="order_head">
                <div style="font-size:larger;text-align:left;margin-top:1%;margin-left:1%">Orders</div>
                <div id="buttons_order">
                    <button class="btn-item">Today</button>
                    <button class="btn-item">Monthly</button>
                    <button class="btn-item">Annual</button>
                </div>
            </div>
            <div id="order_data">
                <img src="/images/graph1.png" alt="graph_orders" style="width:100%;height:90%" />
                <div>
                    <div class="item-res">
                        <div class="data_head">
                        ...
                        <div style="display: grid; grid-template-columns: 48% 52%; margin-bottom:2%">
                            <div class="bar1" style="background-color:#0c9428;"></div>
                            <div class="bar2" style="background-color:#ccbdbd; "></div>
                        </div>
                    </div>
                    <div class="item-res">
                        <div class="data_head">
            ...
            <div id="ttl_msg">
                ...
                <div id="table_msg_upd">
                    <div style="display:grid;grid-template-columns:20%80%;">
                        <i id="email" class="material-icons" style="font-size:x-large ;margin-top:20%">email</i>
                        <p style="text-align:left ; font-size:large"> New messages</p>
                    </div>
                    <div style="text-align:left ;margin-left:7%;">You have 22 new messages and 16 waiting in draft folder.</div>
                </div>
            </div>

            <ul id="msg_db" style="background-color:white; margin-top:-3.5%; ">
            ...
            <div id="all_tables">
                <div id="user_list_section">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="color: #0c9428;">
                                        <i class='fas fa-level-up-alt' style=" font-size:1vw;"></i>98%
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>Agnes</td>
                                    <td style="color: #0c9428;">
                                        <i class='fas fa-level-up-alt' style=" font-size:1vw;"></i>24%
                                    </td>
                                </tr>
                                <tr>
                                    <td>Pending</td>
                                    ...
                                    <td>John</td>
                                    <td style="color: #0c9428;">
                                        <i class='fas fa-level-up-alt' style=" font-size:1vw;"></i>60%
                                    </td>
                                </tr>
                                <tr>
                                    <td>Pending</td>
                                    ...
                                    <td>Monica</td>
                                    <td style="color: #0c9428;">
                                        <i class='fas fa-level-up-alt' style=" font-size:1vw;"></i>55%
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div id="table_list">
                        ...
                        <div id="list">
                            <div class="item-list" style="margin-top:1%">
                                <input class="btn_check" id="check" type="checkbox" checked="true">
                                <label style="text-decoration: line-through;" class="showOverlay" for="check">Buy a milk </label>
                            </div>
                            <div class="item-list">
                                <input class="btn_check" id="check" type="checkbox">
